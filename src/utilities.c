...
// 	return
// is_result_good(rbpp.bytes_written);
// }

// bool are_all_results_good (result_bytes_processed_pair rbpp){
// 	return is_bytes_read_good(rbpp) &&
// is_bytes_written_good(rbpp);
// }
...
// 	return
// are_all_results_good(ctrbp.prev_file_processed);
// }

// bool is_cur_file_result_good (compare_two_result_bytes_processed ctrbp){
// 	return
// are_all_results_good(ctrbp.cur_file_processed);
// }

// bool are_both_file_results_good (compare_two_result_bytes_processed ctrbp){
// 	return is_prev_file_result_good(ctrbp)
// && is_cur_file_result_good(ctrbp);
// }
